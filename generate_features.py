...
def generate_features_time_series(train, test, bounds=(12, 13, 14, 15, 16, 17)):
    ...
    train_test_joined = count_features(
        ...
        columns_agg=[
            ...
            ['card1', 'subcard_categorical_D4'],
            ['card1', 'subcard_categorical_D4', 'DeviceInfo'],
            ['card1', 'subcard_categorical_D4', 'P_emaildomain'],
            ['card1', 'subcard_categorical_D4', 'ProductCD'],
            ['card1', 'subcard_categorical_D4', 'addr1'],
            ['card1', 'subcard_categorical_D4', 'id_20'],
            ['card1', 'subcard_categorical_D4', 'id_19'],
            ['card1', 'subcard_categorical_D4', 'id_31'],
            ['card1', 'subcard_categorical_D4', 'card4'],
            ['card1', 'subcard_categorical_D4', 'ProductCD', 'addr1'],
